...
generate_obis! {
    ...
    (NegativReactiveEnergyTotal, &[1, 0, 4, 8, 0,255],"Negative reactive energy (Q-) total [kvarh]"),
    (NegativReactiveEnergyTarif1, &[1, 0, 4, 8, 1,255],"Negative reactive energy (Q-) in tariff T1 [kvarh]"),
    (NegativReactiveEnergyTarif2, &[1, 0, 4, 8, 2,255],"Negative reactive energy (Q-) in tariff T2 [kvarh]"),
    (NegativReactiveEnergyTarif3, &[1, 0, 4, 8, 3,255],"Negative reactive energy (Q-) in tariff T3 [kvarh]"),
    (NegativReactiveEnergyTarif4, &[1, 0, 4, 8, 4,255],"Negative reactive energy (Q-) in tariff T4 [kvarh]"),
    ...
    (NegativActiveEnergyPhaseL1Total, &[1, 0, 22, 8, 0,255],"Negative active energy (A-) in phase L1 total [kWh]"),
    (NegativActiveEnergyPhaseL2Total, &[1, 0, 42, 8, 0,255],"Negative active energy (A-) in phase L2 total [kWh]"),
    (NegativActiveEnergyPhaseL3Total, &[1, 0, 62, 8, 0,255],"Negative active energy (A-) in phase L3 total [kWh]"),
    ...
    (NegativActiveMaximumDemandTotal, &[1, 0, 2, 6, 0,255],"Negative active maximum demand (A-) total [kW]"),
    (NegativActiveMaximumDemandTarif1, &[1, 0, 2, 6, 1,255],"Negative active maximum demand (A-) in tariff T1 [kW]"),
    (NegativActiveMaximumDemandTarif2, &[1, 0, 2, 6, 2,255],"Negative active maximum demand (A-) in tariff T2 [kW]"),
    (NegativActiveMaximumDemandTarif3, &[1, 0, 2, 6, 3,255],"Negative active maximum demand (A-) in tariff T3 [kW]"),
    (NegativActiveMaximumDemandTarif4, &[1, 0, 2, 6, 4,255],"Negative active maximum demand (A-) in tariff T4 [kW]"),
    ...
    (NegativReactiveMaximumDemandTotal, &[1, 0, 4, 6, 0,255],"Negative reactive maximum demand (Q-) total [kvar]"),
    ...
    (NegativActiveCumulativeMaximumDemandTotal, &[1, 0, 2, 2, 0,255],"Negative active cumulative maximum demand (A-) total [kW]"),
    (NegativActiveCumulativeMaximumDemandTarif1, &[1, 0, 2, 2, 1,255],"Negative active cumulative maximum demand (A-) in tariff T1 [kW]"),
    (NegativActiveCumulativeMaximumDemandTarif2, &[1, 0, 2, 2, 2,255],"Negative active cumulative maximum demand (A-) in tariff T2 [kW]"),
    (NegativActiveCumulativeMaximumDemandTarif3, &[1, 0, 2, 2, 3,255],"Negative active cumulative maximum demand (A-) in tariff T3 [kW]"),
    (NegativActiveCumulativeMaximumDemandTarif4, &[1, 0, 2, 2, 4,255],"Negative active cumulative maximum demand (A-) in tariff T4 [kW]"),
    ...
    (NegativReactiveCumulativeMaximumDemandTotal, &[1, 0, 4, 2, 0,255],"Negative reactive cumulative maximum demand (Q-) total [kvar]"),
    ...
    (NegativReactiveDemandCurrentDemandPeriod, &[1, 0, 4, 4, 0,255],"Negative reactive demand in a current demand period (Q-) [kvar]"),
    ...
    (NegativActiveDemandLastCompletedDemandPeriod, &[1, 0, 2, 5, 0,255],"Negative active demand in the last completed demand period (A-) [kW]"),
    ...
    (NegativReactiveDemandLastCompletedDemandPeriod, &[1, 0, 4, 5, 0,255],"Negative reactive demand in the last completed demand period (Q-) [kvar]"),
    ...
    (NegativActiveInstantaneousPower, &[1, 0, 2, 7, 0,255],"Negative active instantaneous power (A-) [kW]"),
    (NegativActiveInstantaneousPowerPhaseL1, &[1, 0, 22, 7, 0,255],"Negative active instantaneous power (A-) in phase L1 [kW]"),
    (NegativActiveInstantaneousPowerPhaseL2, &[1, 0, 42, 7, 0,255],"Negative active instantaneous power (A-) in phase L2 [kW]"),
    (NegativActiveInstantaneousPowerPhaseL3, &[1, 0, 62, 7, 0,255],"Negative active instantaneous power (A-) in phase L3 [kW]"),
    ...
    (NegativReactiveInstantaneousPower, &[1, 0, 4, 7, 0,255],"Negative reactive instantaneous power (Q-) [kvar]"),
    (NegativReactiveInstantaneousPowerPhaseL1, &[1, 0, 24, 7, 0,255],"Negative reactive instantaneous power (Q-) in phase L1 [kvar]"),
    (NegativReactiveInstantaneousPowerPhaseL2, &[1, 0, 44, 7, 0,255],"Negative reactive instantaneous power (Q-) in phase L2 [kvar]"),
    (NegativReactiveInstantaneousPowerPhaseL3, &[1, 0, 64, 7, 0,255],"Negative reactive instantaneous power (Q-) in phase L3 [kvar]"),
